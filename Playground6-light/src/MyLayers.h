...
//
//        ObjectShader->Bind();
//        ObjectShader->SetUniformMat4f("u_ModelMatrix", m_Model->GetModelMatrix());
//        ObjectShader->SetUniformMat3f("u_NormalMatrix", m_Model->GetNormalMatrix());
//        ObjectShader->Unbind();
//
//        for(auto& mesh : m_Model->GetMeshes())
//            Renderer::Draw(mesh, *ObjectShader, m_Model->GetMaterial());
//    }
//
...
//        }
//        */
//        m_Model = std::shared_ptr<Model>(new Model("res/3Dobjects/michael/michael.obj"));
//        //m_Model->SetScale(glm::vec3(0.02f));
//    }
//    void InitLights()
//    {
